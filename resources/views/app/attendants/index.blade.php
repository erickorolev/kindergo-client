                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            href="{{ route('attendants.edit', $attendant) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $attendant)
                                        <a
                                            href="{{ route('attendants.show', $attendant) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $attendant)
                                        <form
                                            action="{{ route('attendants.destroy', $attendant) }}"
                                            method="POST"
