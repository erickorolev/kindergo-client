        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            name="trip.attendant_id"
                            label="Attendant"
                            wire:model="trip.attendant_id"
                        >
                            <option value="null" disabled>Please select the Attendant</option>
                            @foreach($timetableAttendants as $value => $label)
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.timetable_trips.inputs.where_address')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.timetable_trips.inputs.date')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.timetable_trips.inputs.time')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.timetable_trips.inputs.childrens')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.timetable_trips.inputs.status')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.timetable_trips.inputs.attendant_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
