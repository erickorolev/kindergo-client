    ...
    <div class="s-trips py-8">
      <div class="container mx-auto">
        <div class="flex justify-between items-center s-trips-top">
          <div>
            <h2 class="text-black text-2xl">Ваши дети</h2>
          </div>
        </div>
        <div class="s-trips-table pt-8">
          <div
            class="divide-y divide-black border-t border-black border-b md:w-full w-auto"
          >
            <div>
              <div
              ...
              >
                ...
                <div class="pl-3.5 w-44">Дата рождения</div>
              </div>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                <span class="pl-3.5 w-44">{{
                  ("0" + new Date(item.birthday).getDate()).substr(-2) +
                  "." +
                  ("0" + (new Date(item.birthday).getMonth() + 1)).substr(-2) +
                  "." +
...
export default defineComponent({
  ...
  setup() {
    ...
    return { children, links, current_page };
  },
  mounted() {
