...
namespace Domains\Attendants\ValueObjects;

use Parents\Exceptions\ValidationFailedException;
use Parents\ValueObjects\ValueObject;
use Propaganistas\LaravelPhone\PhoneNumber;

final class AttendantPhoneNumber extends ValueObject
{
    /**
     ...
     */
    public static function fromNative($native, ?string $country = null): AttendantPhoneNumber
    {
        if (!$native) {
